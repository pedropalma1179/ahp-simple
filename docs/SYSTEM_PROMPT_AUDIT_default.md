# AUDITORIA — SYSTEM_PROMPT renderizado (Phase 7.2 v8.1.6)

Cenario: DEFAULT (sem validacao externa, sem exclusao de respondentes, sem sensitivity criticos)

Tamanho total: 41648 chars
Linhas: 1
