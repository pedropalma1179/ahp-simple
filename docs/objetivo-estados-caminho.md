...
A.30 ou A.31 bloqueiem a correção de citações, de metadados ou do ingestor. A
única precedência técnica entre elas é a de A.30 sobre A.18, que está na tabela
acima.
